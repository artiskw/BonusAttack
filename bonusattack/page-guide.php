    ...
    <div class="guides-container">
        ...
        <?php foreach ($posts as $key => $post) : ?>
            <?php if ($key === 1) : ?>
                <div class="guides-post">
                    <div class="title-paragraph">
                        ...
                        <div class="paragraph">
                            ...
                            <a href="<?php echo get_permalink($post); ?>">Read More
                ...
                <div class="companies-container guides-page">
                    <?php $companies = get_field('companies', 18); ?>
                                    ...
                                    <div class="bonus-btn-companies-options">
                                        <div class="bonus-btn-container">
                                            ...
                                            <div class="btn-container breakpoint">
                                                ...
                                                <a class="full-tc-apply"
                                                   href="<?php echo get_field('terms_link', $company->ID); ?>" target="_blank">18+ | Play Responsibly | T&C Apply
                                                </a>
                                            </div>
                                        </div>
                                        <div class="companies-options">
                                            <div class="score">
                                                ...
                                                <div class="our-score-container">
                                                    <h6>Our Score:</h6>
                                                    <p><span><?php echo get_field('our_rating', $company->ID); ?></span>/10
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="rating">
